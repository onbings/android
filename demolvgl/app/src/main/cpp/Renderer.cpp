...
void Renderer::initRenderer() {
    ...
    bool UseGlesV3_B = false;
    const EGLint GlesVersionBit = UseGlesV3_B ? EGL_OPENGL_ES3_BIT:EGL_OPENGL_ES2_BIT;
    const EGLint attribs[] = {
            EGL_RENDERABLE_TYPE, GlesVersionBit,
    ...
    EGLint contextAttribs[] = {EGL_CONTEXT_CLIENT_VERSION, UseGlesV3_B ? 3:2, EGL_NONE};
